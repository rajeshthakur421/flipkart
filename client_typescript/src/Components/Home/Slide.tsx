...
import { Product, MultiSlideProps, SlideProps } from '../../types/interfaces';
...
const MultiSlide = ({ data, timer, title }: MultiSlideProps) => {
...
const Slide = (props: SlideProps) => {
    return (
        <>
            {
                props.multi === true ? <MultiSlide {...props} /> : null
            }
        </>
    )
}
